package sawfowl.clearlag.utils;
...
public class Logger {
	...
	private org.apache.logging.log4j.Logger logger = LogManager.getLogger("ClearLag");
	public Logger(){}
	...
	public void warn(String string) {
		logger.warn(TextUtils.clearDecorations(string));
	}
	...
	public void error(String string) {
		logger.error(TextUtils.clearDecorations(string));
	}
	...
	public void debug(String string) {
		logger.debug(TextUtils.clearDecorations(string));
	}
